...
while cv2.waitKey(1) < 0:
    ...
    # angle print
    cv2.putText(frame, "angle:{:.0f}".format(getAngle3P(0,1,14)), (int(point_x[1]), int(point_y[1])), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 0, 0), 1, lineType=cv2.LINE_AA)
    cv2.putText(frame, "angle:{:.0f}".format(getAngle3P(1,14,8)), (int(point_x[14]), int(point_y[14])), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 0, 0), 1, lineType=cv2.LINE_AA)
    cv2.putText(frame, "angle:{:.0f}".format(getAngle3P(14,8,9)), (int(point_x[8]), int(point_y[8])), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 0, 0), 1, lineType=cv2.LINE_AA)
