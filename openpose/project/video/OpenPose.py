        ...
        for pair in POSE_PAIRS_left:
            ...
            if points[partA] and points[partB]:
                if (160 <= getAngle3P(0,1,14) <= 180) and (165 <= getAngle3P(1,14,11) <= 180) and (100 <= getAngle3P(14,11,12) <= 120) :
                    cv2.putText(frame, "proper pose", (30,50), cv2.FONT_HERSHEY_COMPLEX, .8, (255, 50, 0), 2, lineType=cv2.LINE_AA)
                else:
                    cv2.putText(frame, "wrong pose", (30,50), cv2.FONT_HERSHEY_COMPLEX, .8, (255, 50, 0), 2, lineType=cv2.LINE_AA)
